...
import { getAllStarterTemplates } from '../backend/services/judge/lld/lldTemplateGenerator.js';
...
async function runAudit() {
  ...
  console.log(`Topics (CurriculumTopic):       ${byType.CurriculumTopic.length}`);
  ...
  console.log(`Starter Code Issues: ${starterCodeIssues.length === 0 ? '✓ ZERO missing starter codes (C++, Java, Python all present for all 127 executable tasks)' : JSON.stringify(starterCodeIssues)}`);
